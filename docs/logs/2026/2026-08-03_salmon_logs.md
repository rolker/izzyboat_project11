...
**2026-08-03 18:57 -04:00** — wrap-up commits complete. ccomjhc_project11: salmon commit 7fc7860 (add bizzyboat_ntrip_udel.yaml) + gabby agent commit 0084028 (default switched to UDEL) merged as 52d6fc1, pushed; per operator decision the committed DEFAULT stays UDEL until the trip ends — swap back to MaCORS when leaving Broadkill (supersedes the earlier revert-at-wrap-up plan). unh_echoboats_project11: gabby agent's 10 commits + salmon log commit 6b963ce pushed. All field repos clean and in sync on both hosts
